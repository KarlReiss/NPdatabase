...
import { setCssVar, humpToUnderline } from '@/app/utils'
import { colorIsDark, hexToRGB, lighten, mix } from '@/app/utils/color'
...
export const useAppStore = defineStore(EventsConfigs.pinia.app, {
  state: (): AppState => {
    return {
      ...
      theme: {
        ...
        // 左侧菜单背景颜色
        leftMenuBgColor: 'var(--el-color-primary)',
        // 左侧菜单浅色背景颜色
        leftMenuBgLightColor: '#02BFE7',
        // 左侧菜单选中背景颜色
